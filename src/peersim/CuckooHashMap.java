...
public final class CuckooHashMap<K, V> extends AbstractMap<K, V> {
    ...
    @Override
   	public String toString() {
   		return "CuckooHashMap [THIS=" + super.toString() + ", \n" + 
   				"[mArrays=" + Arrays.deepToString(mArrays) + ", \n mHashFns=" + Arrays.deepToString(mHashFns)
   				+ ", \n mUniversalHashFunction=" + mUniversalHashFunction + ", \n mSize=" + mSize + "]";
   	}
}
